...
$langArray = [
        ...
        'calender' => [
            'todayBtn' => 'hoje',
            'showBtn1' => 'Onde estamos ?',
            'showBtn2' => 'Clique aqui',
        ],
        'landingText' => [
            'mainHeader' => 'Creparia Artesanal',
            'underHeader' => 'Quem prova quer mais!',
            'checkProductStart' => 'Clique',
            'checkProductsEnd' => 'para ver os nossos produtos',
            'checkProductsBtn' => 'aqui',
        ],
        'concept' => [
            'title' => 'Conceito',
            'description' => '
        ...
        'events' => [
            'title' => 'Eventos',
            'description' => '
                <p>Vai haver festa? O BOM² pode torná-la deliciosa! Fazemos todo o tipo de eventos.</p>
                <p>Pede já a tua proposta:</p>
                <ol>
                    <li>Nome</li>
                    <li>Email</li>
                    <li>Telemóvel</li>
        ...
        'contacts' => [
            ...
            'contactForm' => [
                ...
                'messageArea' => 'A sua mensagem',
                'sendBtn' => 'Enviar',
                'messageSentSuccess' => 'Mensagem enviada &#10003;',
                'messageSentFail' => 'De momento não conseguimos enviar a mensagem.',
                'termsStart' => 'Li e aceito',
                'termsLink' => 'os termos',
                'fillAllFieldsMsg' => 'Todos os campos tem que ser preenchidos e aceite os termos.',
            ]
        ],
        'footerDevBy' => 'Desenvolvido por:',
        'cookie' => [
            'text' => 'Ao continuar a usar este site, você concorda com o uso de cookies.',
            'btnAccept' => 'Aceito',
            'btnDeny' => 'Não'
        ],
    ]
